    ...
    <div className="container">
        <div className="card">
            ...
            <div className="contenido">
                <h3> Contaabilidad </h3>
                <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit sed debitis eos tenetur. Necessitatibus eveniet ipsam aperiam delectus ipsum ea magnam. Iusto ducimus
                     commodi architecto minus harum, quaerat quos aperiam.</p>
                     <a href="#"> Leer mas</a>
            </div>
        </div>
        <div className="card">
